...
const Blog = () => {
    ...
    return (
        <div className="container py-5 text-center" id="blog">
            <h1 className="display-4 font-semibold mb-5 text-success">Latest Blog Posts</h1>
                    ...
                    <div className="col-md-4" key={index}>
                        <div className="card h-100 text-center bg-dark text-light border-success d-flex flex-column justify-content-center">
                            <div className="card-body d-flex flex-column align-items-center">
                                ...
                                <a href={post.url} target="_blank" rel="noopener noreferrer" className="btn btn-success">Read More</a>
                            </div>
                        </div>
                    </div>
                ))}
