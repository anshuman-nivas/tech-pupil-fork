    ...
    return (
        <div id="#contact"className="p-4 lg:p-20 flex flex-col items-center justify-center   ">
            ...
            <form action="" className="flex flex-col gap-2 lg:w-1/2">
                ...
                <button className="neno-button shadow-xl hover:shadow-green-600/50 text-white border-2 border-freen-600 bg-green-500 hover:bg-slate-900 rounded-lg py-4 px-8 my-6 uppercase relative overflow-hidden b_glow text-xl text-bold mb-10" type="submit">Submit</button>
            </form>
